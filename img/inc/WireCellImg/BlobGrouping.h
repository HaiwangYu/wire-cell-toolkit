/** BlobGrouping takes in a channel-level cluster and produces another with
 * channels merged ('m' nodes)
 *
 * The input cluster must have (b,w), (c,w) and (s,b) edges and may have (b,b)
 * edges.
 *
 * The output cluster will have (m, b) and (s,b) edges and if the input has
 * (b,b) edges, they are preserved.
 *
