...
typedef std::unordered_map<WirePlaneLayer_t, cluster_indexed_graph_t>
    layer_graphs_t;
...
static void fill_blob(layer_graphs_t &lgs, const cluster_indexed_graph_t &grind,
                      IBlob::pointer iblob)
{
...
bool Img::BlobGrouping::operator()(const input_pointer &in,
                                   output_pointer &out)
{
    if (!in)
    {
