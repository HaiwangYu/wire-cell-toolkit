...
WIRECELL_FACTORY(SlicesSink, WireCell::Img::SlicesSink, WireCell::ISliceFrameSink, WireCell::IConfigurable)
...
void Img::SlicesSink::configure(const WireCell::Configuration &cfg) { m_cfg = cfg; }
