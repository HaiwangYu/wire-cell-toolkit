...
bool Gen::BinnedDiffusion::add(IDepo::pointer depo, double sigma_time,
                               double sigma_pitch)
{
...
void Gen::BinnedDiffusion::erase(int begin_impact_number,
                                 int end_impact_number)
{
...
Gen::BinnedDiffusion::pitch_range(double nsigma) const
{
...
std::pair<int, int>
Gen::BinnedDiffusion::impact_bin_range(double nsigma) const
{
...
std::pair<double, double>
Gen::BinnedDiffusion::time_range(double nsigma) const
{
    std::vector<Gen::GausDesc> gds;
    for (auto diff : m_diffs)
    {
