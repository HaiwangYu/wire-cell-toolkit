...
namespace WireCell {
    ...
    class WireParams : public IWireParameters, public IConfigurable {
       public:
         ...
         */
        void set(double dx = 10 * units::mm, double dy = 1 * units::meter, double dz = 1 * units::meter,
                 double pitch = 10 * units::mm, double angle = 60.0 * units::degree);
