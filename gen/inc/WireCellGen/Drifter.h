 ...
 *
 * $ wriecell-sigproc response-info
 * garfield-1d-3planes-21wires-6impacts-dune-v1.json.bz2 origin:10.00 cm,
 * period:0.10 us, tstart:0.00 us, speed:1.60 mm/us, axis:(1.00,0.00,0.00)
 ...
 * ....
 * anode:5 face:1 X=[3584.63,3584.63]mm Y=[6066.70,6066.70]mm
 * Z=[6940.01,6940.01]mm 0: x=3584.63mm dx=-9.5250mm 1: x=3589.39mm dx=-4.7620mm
 *     2: x=3594.16mm dx=0.0000mm
 *
        ...
        class Drifter : public IDrifter, public IConfigurable
        {
           ...
           private:
            ...
            struct IsInsideBulk
            {
                ...
                {
                    return xr.inside_bulk(depo->pos().x());
                }
            };
            struct IsInsideResp
            {
                ...
                bool operator()(const Xregion &xr) const
                {
                    return xr.inside_response(depo->pos().x());
                }
            };
