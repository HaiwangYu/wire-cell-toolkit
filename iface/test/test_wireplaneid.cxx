...
int main()
{
    ...
    cerr << "u.ident=" << u.ident() << " v.ident=" << v.ident()
         << " w.ident=" << w.ident() << endl;
    ...
    for (int ilayer = 0; ilayer < 4; ++ilayer)
    {
        ...
        for (int face = 0; face < 2; ++face)
        {
            ...
            {
                cerr << "Raw: " << ilayer << " " << layer << " " << face << " " << apa
                     << endl;
                ...
                cerr << "\tident=" << wpid.ident() << " ilayer=" << wpid.ilayer()
                     << " layer=" << wpid.layer() << " index=" << wpid.index() << endl;
