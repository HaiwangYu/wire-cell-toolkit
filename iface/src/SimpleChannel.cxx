...
int SimpleChannel::ident() const { return m_ident; }
int SimpleChannel::index() const { return m_index; }
const IWire::vector &SimpleChannel::wires() const { return m_wires; }
...
void SimpleChannel::set_index(int ind) { m_index = ind; }
