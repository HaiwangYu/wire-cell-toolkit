...
WIRECELL_FACTORY(ROIDNN, WireCell::Sig::ROIDNN, WireCell::ITensorSetFilter, WireCell::IConfigurable)
...
Configuration Sig::ROIDNN::default_configuration() const
{
    Configuration cfg;
    cfg["tag"] = "tag";
...
void Sig::ROIDNN::configure(const WireCell::Configuration &cfg)
{
    m_cfg = cfg;
}

bool Sig::ROIDNN::operator()(const ITensorSet::pointer &in, ITensorSet::pointer &out)
{
    log->trace("ROIDNN: start");
