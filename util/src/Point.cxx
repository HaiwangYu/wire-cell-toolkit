...
bool WireCell::point_contained(const WireCell::Point &point,
...
bool WireCell::point_contained(const WireCell::Point &point,
                               const WireCell::Ray &bounds, int axis)
{
...
double WireCell::point_angle(const WireCell::Vector &axis,
                             const WireCell::Vector &vector)
{
...
WireCell::Ray WireCell::ray_pitch(const WireCell::Ray &pu,
                                  const WireCell::Ray &qv)
{
...
double WireCell::ray_dist(const WireCell::Ray &ray,
...
WireCell::Ray WireCell::box_intersect(const Ray &s1, const Ray &s2)
{
    ...
    for (size_t ind = 0; ind < 3; ind++)
    {
        ...
        if (lb1 > rb1)
            std::swap(lb1, rb1);  // let left < right
