...
WireCell::RayGrid::blobproj_t
WireCell::RayGrid::projection(const blobvec_t &blobs, layer_index_t layer)
{
    blobproj_t ret;
...
WireCell::RayGrid::blobvec_t
WireCell::RayGrid::references(const blobs_t &blobs)
{
...
void WireCell::RayGrid::associate(const blobs_t &one, const blobs_t &two,
                                  associator_t func)
{
