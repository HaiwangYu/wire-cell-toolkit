...
void RayGrid::Grouping::add(char ntype, ident_t chid, std::vector<ident_t> wids,
...
RayGrid::Grouping::clusterset_t RayGrid::Grouping::clusters()
{
    ...
    int nstripes = boost::connected_components(
...
RayGrid::Solving::vertex_t
RayGrid::Solving::source_node(ident_t sid, float value, float weight)
{
...
RayGrid::Solving::vertex_t RayGrid::Solving::measurement_node(float value,
                                                              float weight)
{
...
RayGrid::Solving::solution_t RayGrid::Solving::solve()
{
    ...
    int nprobs = boost::connected_components(
