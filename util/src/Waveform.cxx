...
std::pair<int, int>
WireCell::Waveform::sub_sample(const Waveform::Domain &domain, int nsamples,
...
Waveform::realseq_t
WireCell::Waveform::magnitude(const Waveform::compseq_t &seq)
{
...
Waveform::real_t
WireCell::Waveform::percentile_binned(Waveform::realseq_t &wave,
                                      real_t percentage)
{
...
Waveform::realseq_t WireCell::Waveform::replace_convolve(
    Waveform::realseq_t wave, Waveform::realseq_t newres,
    Waveform::realseq_t oldres, bool truncate)
{
    size_t sizes[3] = {wave.size(), newres.size(), oldres.size()};
    size_t n_out =
        sizes[0] + sizes[1] + sizes[2] - *std::min_element(sizes, sizes + 3) - 1;
...
void WireCell::Waveform::merge(ChannelMaskMap &one, ChannelMaskMap &two,
