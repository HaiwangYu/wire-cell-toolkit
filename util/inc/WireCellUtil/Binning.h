...
*/
    class Binning
    {
       ...
       public:
        /** Create a binning
      \param nbins gives the number of uniform, discrete separation between
     bounds. \param minval gives the lower bound of the linear space (low edge
     of bin 0) \param maxval gives the upper bound of the linear space (high
     edge of bin nbins-1)
  */
