...
int main(const int argc, char *argv[])
{
    ...
    /// output file
    // TFile* rootfile = TFile::Open(Form("%s.root", out_basename.c_str()),
    // "recreate");
    ...
    // point charge case, if at right boundary of the bin, in next impact pitch,
    // not shown in the following. Other cases will overwrite.
    x[5] = 0.3;
    y[5] = 0;
    xc[5] = 0.3;
    yc[5] = 0;
