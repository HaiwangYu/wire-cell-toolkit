...
int main(int argc, char **argv)
{
    ...
    if (nInputs == 0 || nBegin == 0 || nEnd == 0 || id == 0)
    {
        cerr << endl
             << " Usage: " << endl
             << "\t"
             << "./test_scan_fft -id ID_Num -n NumA -b NumB -e NumC" << endl
             << endl;
    }
    ...
    {
        cout << endl
             << " nSamples, fwd_time, fwd_time per sample, rev_time, rev_time per "
                "sample, average time of (fwd and rev)"
             << endl
             << endl;
        ...
        for (auto nsamps : nsampleslist)
        {
            ...
            // cout<<TString::Format(" DFT nsamples= %5d, tforward: %7.2f us, %9.6f
            // us/sample, treverse: %7.2f us, %9.6f us/sample, taverage: %7.2f us",
            // 			    nsamps,
