                ...
                IRandom::pointer fluctuate)
{
    ...
    for (double dist = 0.0; dist < track_length; dist += stepsize)
    {
        ...
        // cerr << "dist: " <<dist/units::mm << "mm, drift: " <<
        // drift_time/units::us << "us depo:" << depo->pos() << " @ " <<
    ...
    for (int iwire = 0; iwire < nwires; ++iwire)
    {
        ...
        // cerr <<
        // "t:"<<ntbins<<"["<<min_time/units::us<<","<<max_time/units::us<<"]us
        // ("<<max_time-min_time<<")\n"; cerr <<
        // "p:"<<npbins<<"["<<min_pitch/units::mm<<","<<max_pitch/units::mm<<"]mm\n";
