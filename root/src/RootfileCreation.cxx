...
WIRECELL_FACTORY(RootfileCreation_frames,
                 WireCell::Root::RootfileCreation_frames, WireCell::IDepoFilter,
...
void Root::RootfileCreation_depos::configure(
...
Root::RootfileCreation_depos::default_configuration() const
{
    Configuration cfg;
    cfg["output_filename"] = "";
...
bool Root::RootfileCreation_depos::
operator()(const WireCell::IDepo::pointer &indepo,
...
void Root::RootfileCreation_frames::configure(
    const WireCell::Configuration &cfg)
{
    m_cfg = cfg;
    create_file();
...
WireCell::Configuration
Root::RootfileCreation_frames::default_configuration() const
{
    Configuration cfg;
    cfg["output_filename"] = "";
    cfg["root_file_mode"] = "RECREATE";
...
bool Root::RootfileCreation_frames::
operator()(const WireCell::IFrame::pointer &in,
