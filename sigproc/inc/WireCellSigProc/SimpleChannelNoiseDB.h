    ...
    namespace SigProc
    {
        class SimpleChannelNoiseDB : public WireCell::IChannelNoiseDatabase
        {
           public:
            ...
            void set_coherent_nf_decon_limit(const std::vector<int> &channels,
                                             float decon_limit);
            void set_coherent_nf_decon_lf_cutoff(const std::vector<int> &channels,
                                                 float decon_lf_cutoff);
            void set_coherent_nf_decon_limit1(const std::vector<int> &channels,
                                              float decon_limit);
            void set_coherent_nf_adc_limit(const std::vector<int> &channels,
                                           float adc_limit);
            void set_coherent_nf_protection_factor(const std::vector<int> &channels,
                                                   float protection_factor);
            void set_coherent_nf_min_adc_limit(const std::vector<int> &channels,
                                               float min_adc_limit);
            void set_coherent_nf_roi_min_max_ratio(const std::vector<int> &channels,
            ...
            void set_rcrc_constant(const std::vector<int> &channels,
                                   double rcrc = 2000.0);
           ...
           private:
            ...
            float m_default_decon_limit, m_default_decon_lf_cutoff, m_default_adc_limit,
                m_default_decon_limit1, m_default_protection_factor,
                m_default_min_adc_limit, m_default_roi_min_max_ratio;

            std::vector<double> m_baseline, m_gain, m_offset, m_min_rms, m_max_rms;
            std::vector<int> m_pad_f, m_pad_b;
            std::vector<float> m_decon_limit, m_decon_lf_cutoff, m_adc_limit,
                m_decon_limit1, m_protection_factor, m_min_adc_limit, m_roi_min_max_ratio;
            ...
            get_filter(int channel, const filter_vector_t &fv) const;
