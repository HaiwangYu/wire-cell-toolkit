...
namespace TorchScript
{
    void forward(int threadid, torch::jit::script::Module &module)
    {
        ...
        // inputs.push_back(torch::rand({1, 3, 800, 600},
        // torch::dtype(torch::kFloat32).device(torch::kCPU, 0)));
        ...
        std::cout << "th " << threadid << " waited: " << total_wait_time / 1000
                  << " sec." << std::endl;
        return;
    }
}  // namespace TorchScript
...
{
    // if (argc != 3) {
    //   std::cout << "usage: threads <path-to-exported-script-module>
    //   nthreads\n"; return -1;
    // }
    ...
    std::cout
        << "WireCell::pytorch : test multi-threading of TorchScript Model\n";
    ...
    catch (const torch::Error &e)
    {
        ...
        std::cout
            << "example models: "
               "https://github.com/HaiwangYu/Pytorch-UNet/tree/master/ts-model\n";
        return 1;
    }
